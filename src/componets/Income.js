...
const Income = () => {
  const [months, setMonths] = useState({
    January: {
      isOpen: true,
      entries: [
        { source: 'Brother kunjali', amount: 1000.00, tag: 'Pocket money' },
        { source: 'Father', amount: 100.00, tag: 'Pocket money' },
        { source: 'Father', amount: 100.00, tag: 'Pocket money' }
      ]
    },
    February: {
  ...
  const tags = ['Pocket money', 'Salary', 'Gift', 'Investment'];
  ...
  const addNewEntry = (month) => {
    setMonths(prev => ({
      ...
      [month]: {
        ...prev[month],
        entries: [...prev[month].entries, { source: '', amount: 0, tag: 'Pocket money' }]
      }
    }));
  };
